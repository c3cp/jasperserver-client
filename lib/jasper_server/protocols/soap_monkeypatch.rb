  ...
  module RPC
    ...
    class Proxy
      ...
      def call(name, *params)
        ...
        puts "jasperserver-client soapmonkeypatch.rb - in call and name is #{name}"
        ...
        # SHWARE - this call is failing with soap4r-1.5.8 - no elementformdefault or attributeFormDefault on SOAP::RPC::Proxy::Operation
